    ...
    <div class="container pt-5">
        <div class="row">
            ...
            <div class="col-md-4 order-md-1 col-lg-3 sidebar-filter">
                <h3 class="mt-0 mb-5">{{ __('shop_lang.index.products') }} <span class="text-primary">{{ count($products) }}</span></h3>
                <h6 class="text-uppercase font-weight-bold mb-3">{{ __('shop_lang.index.categories') }}</h6>
                ...
                <h6 class="text-uppercase mt-5 mb-3 font-weight-bold">{{ __('shop_lang.index.price') }}</h6>
                ...
                <div class="divider mt-5 mb-5 border-bottom border-secondary"></div>
                <a href="#" class="btn btn-lg btn-block btn-primary mt-5">{{ __('shop_lang.index.update_results') }}</a>
            </div>
